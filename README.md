...
warn! Бот и его БД, развернуты на VDS-сервере timeweb, последние несколько месяцев идет DDOS атака на их инфраструктуру. Для проверки доступности бота можно воспользоваться [сервисом](https://telnet-online.net/).
 *Вставьте в нижнюю строку*
> telnet 188.225.43.162 3306

*Ответ, если работает*
> Connection to 188.225.43.162:3306 - ok

**Другие варианты:**
- netcat
    >nc -zv 188.225.43.162 3306
- bash, утилитиа mysqladmin
   >mysqladmin -h 188.225.43.162 -u ivank -p status
